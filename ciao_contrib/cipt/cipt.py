...
class CIAOImage(IMAGECrate):
    ...
    def __init__(self, filename):
        ...
        for nl in ["min", "max", "mean", "median", "mode", "mid",
                   "sigma", "extreme", "locheq", "kuwahara", "unsharp",
                   "range", "variance", "nmode", "q25", "q33", "q67",
                   "q75", "mcv", "sum", "rclip", "peak", "valley",
                   "count", "olympic", "pmean", "mu3", "mu4", "jitter",
                   "rms", "nslope"]:
        ...
        for cst in ["byte", "short", "long", "ushort", "ulong",
                    "float", "double", "int"]:
    ...
    def _adaptive_smooth(self, kernel, counts):
        ...
        return _run_cmd(dmimgadapt, self, counts=counts,
                        function=kernel.function, minrad=kernel.minrad,
                        maxrad=kernel.maxrad, numrad=kernel.numrad,
    ...
    def _get_dmcoords_values(dmcoords):
        ...
        retval = {}
        for vv in ['chip_id', 'chipx', 'chipy', 'tdetx', 'tdety',
                   'detx', 'dety', 'x', 'y', 'logicalx', 'logicaly',
                   'ra', 'dec', 'theta', 'phi']:
    ...
    def stats(self):
        ...
        with serialize_temp_crate(self) as tmpimg:
            ...
            retval = {'min': float(dmstat.out_min),
